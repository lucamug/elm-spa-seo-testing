...
var _lucamug$elm_spa_seo_testing$Main$extractNumber = function (text) {
	var number = A3(
		...
		_elm_lang$core$Regex$regex('\\d{1,2}'),
		text);
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('V = Version, H = History length, A = Type A Ajax, B = Type B Ajax'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_elm_lang$core$Task$perform,
							function (_p4) {
								return _lucamug$elm_spa_seo_testing$Main$FetchApi1Data('6.json');
							},
						...
						_1: {
							...
							_0: A2(
								_elm_lang$core$Task$perform,
								function (_p5) {
									return _lucamug$elm_spa_seo_testing$Main$FetchApi1Data('3.json');
								},
							...
							_1: {
								...
								_0: A2(
									_elm_lang$core$Task$perform,
									function (_p6) {
										return _lucamug$elm_spa_seo_testing$Main$FetchApi1Data('1.json');
									},
								...
								_1: {
									...
									_0: A2(
										_elm_lang$core$Task$perform,
										function (_p7) {
											return _lucamug$elm_spa_seo_testing$Main$FetchApi1Data('0.json');
										},
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												_elm_lang$core$Task$perform,
												function (_p9) {
													return _lucamug$elm_spa_seo_testing$Main$FetchApi2Data('https://httpbin.org/delay/6');
												},
												_elm_lang$core$Process$sleep(0.0 * _elm_lang$core$Time$second)),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$core$Task$perform,
													function (_p10) {
														return _lucamug$elm_spa_seo_testing$Main$FetchApi2Data('https://httpbin.org/delay/3');
													},
													_elm_lang$core$Process$sleep(0.0 * _elm_lang$core$Time$second)),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$core$Task$perform,
														function (_p11) {
															return _lucamug$elm_spa_seo_testing$Main$FetchApi2Data('https://httpbin.org/delay/1');
														},
														_elm_lang$core$Process$sleep(0.0 * _elm_lang$core$Time$second)),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$core$Task$perform,
															function (_p12) {
																return _lucamug$elm_spa_seo_testing$Main$FetchApi2Data('https://httpbin.org/delay/0');
															},
															_elm_lang$core$Process$sleep(0.0 * _elm_lang$core$Time$second)),
														_1: {ctor: '[]'}
													}
...
if (typeof _lucamug$elm_spa_seo_testing$Main$main !== 'undefined') {
    _lucamug$elm_spa_seo_testing$Main$main(Elm['Main'], 'Main', undefined);
}
